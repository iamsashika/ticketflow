    ...
    <div class="card" style="margin-top: 2rem;">
        ...
        <div class="card-body">
            ...
            <?php elseif ($event['status'] !== 'upcoming'): ?>
                <!-- Event Not Available -->
                <div class="alert" style="background: #fee2e2; color: #991b1b; border-left: 4px solid var(--danger-color);">
                    <p><strong>Registration Closed</strong></p>
                    <p>This event is <?php echo htmlspecialchars($event['status']); ?> and is no longer accepting registrations.</p>
                </div>
